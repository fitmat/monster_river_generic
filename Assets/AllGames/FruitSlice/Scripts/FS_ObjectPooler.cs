 ...
 * */
public class FS_ObjectPooler : MonoBehaviour
{
    ...
    public static FS_ObjectPooler instance;
    ...
    public GameObject SpawnFromPool(string tag, Transform spawnPosition, Quaternion spawnRotation)
    {
        GameObject objectToSpawn = objectPools[tag].Dequeue();
        objectToSpawn.SetActive(false);
        objectToSpawn.SetActive(true);
        objectToSpawn.transform.position = spawnPosition.position;
        objectToSpawn.transform.parent = spawnPosition;
