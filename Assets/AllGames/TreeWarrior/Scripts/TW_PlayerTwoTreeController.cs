...
public class TW_PlayerTwoTreeController : MonoBehaviour
{
    public static TW_PlayerTwoTreeController instance;
    ...
    public void CheckTreeHealth()
    {
        ...
        else if (treeHealth == 0)
        {
            ...
            TW_ScoreManager.instance.playerTwoTime = TW_GameController.instance.gameTime;

            if (!TW_PlayerOneController.instance.hasPlayerEnded)
            {
                TW_GameController.instance.winningPlayer = 2;
            }
            TW_PlayerTwoController.instance.hasPlayerEnded = true;
